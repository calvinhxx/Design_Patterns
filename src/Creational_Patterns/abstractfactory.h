...
namespace AbstractFactory {
    ...
    public:
        ...
        virtual void PrintAbstractA()
        {
            std::cout << "ConcreteProductAStyle1\n";
        }
    };
    ...
    public:
        ...
        virtual void PrintAbstractA()
        {
            std::cout << "ConcreteProductAStyle2\n";
        }
    };
    ...
    public:
        ...
        virtual void PrintAbstractB()
        {
            std::cout << "ConcreteProductBStyle1\n";
        }
    };
    ...
    public:
        ...
        virtual void PrintAbstractB()
        {
            std::cout << "ConcreteProductBStyle2\n";
        }
    };
