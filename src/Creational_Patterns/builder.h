...
public:
  Product1() {}
  virtual void Setfeature1() override { std::cout << "P1 F1\n"; }
  virtual void Setfeature2() override { std::cout << "P1 F2\n"; }
  virtual void Setfeature3() override { std::cout << "P1 F3\n"; }
};
///
...
public:
  Product2() {}
  virtual void Setfeature1() override { f1_ = true; }
  virtual void Setfeature2() override { f2_ = true; }
  virtual void Setfeature3() override { f3_ = true; }
  void Print() {
    if (f1_) {
      std::cout << "P2 F1\n";
    } else if (f2_) {
...
public:
  ...
  virtual void BuildStepA() { product_->Setfeature1(); }
  virtual void BuildStepB() { product_->Setfeature2(); }
  virtual void BuildStepC() { product_->Setfeature3(); }

  Product1 *GetResult() { return product_; }
...
public:
  ...
  Product2 *GetResult() { return product_; }
